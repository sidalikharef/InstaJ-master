    ...
    public Task<Void> useLocalInstagramProfile() throws InterruptedException {
        return new Task<Void>() {
            ...
            public Void call() throws InterruptedException, FailingHttpStatusCodeException, IOException {
                ...
                Thread.sleep(1000);
                driver.findElement(By.xpath("//input[@name='username']")).sendKeys("sidalikharef@hotmail.com");//username.getText()
                driver.findElement(By.xpath("//input[@name='password']")).sendKeys("1486325779sidou");//password.getText()
                Thread.sleep(1000);
              ...
              //  Thread.sleep(2000);
              //  driver.findElement(By.xpath("//*[@id=\"react-root\"]/section/nav/div[2]/div/div/div[3]/div/div[5]/div[2]/div[2]/div[2]/a[1]/div")).click();
                return null;
            }
        };
    }
